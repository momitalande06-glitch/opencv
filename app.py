...
class SimpleCNN(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.features = nn.Sequential(
            ...
            nn.BatchNorm2d(16), # Added BatchNorm2d
            nn.ReLU(),
...
# Configuration
IMAGE_SIZE = (250, 250)
CLASS_NAMES = ['cat', 'dog'] # Corrected to match your dataset
...
st.title("Image Classifier: Cat vs. Dog") # Updated title
st.write("Upload an image and let the model predict if it's a cat or a dog.") # Updated description
